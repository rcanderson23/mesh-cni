...
pub use mesh_cni_ebpf_meta::{
    ...
    BPF_MAP_NODEPORT_CONNTRACK_V4, BPF_MAP_NODEPORT_LOCAL_ADDRS_V4, BPF_MAP_NODEPORT_REV_NAT_V4,
    BPF_MAP_NODEPORT_SERVICES_V4, BPF_MAP_POLICY_CIDR_V4, BPF_MAP_POLICY_CIDR_V6,
    BPF_MAP_POLICY_INDEX, BPF_MAP_POLICY_RULESET, BPF_MAP_ROUTER_V4, BPF_MAP_SERVICES_V4,
    BPF_MAP_SERVICES_V6, BPF_MESH_FS_DIR, BPF_MESH_LINKS_DIR, BPF_MESH_MAPS_DIR, BPF_MESH_PROG_DIR,
    BPF_PROGRAM_CGROUP_CONNECT_V4, BPF_PROGRAM_EGRESS_TC, BPF_PROGRAM_INGRESS_TC,
...
pub(crate) const SERVICE_MAPS_LIST: [BpfNamePath; 10] = [
    BPF_MAP_SERVICES_V4,
    BPF_MAP_SERVICES_V6,
...
pub(crate) const TC_VXLAN_PROG_LIST: [BpfNamePath; 3] = [
    ...
    BPF_PROGRAM_HOST_ROUTER_EGRESS_TC,
];

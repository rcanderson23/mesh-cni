...
>
where
    S4: BpfMap<ServiceKeyV4, ServiceValue> + Send + 'static,
    S6: BpfMap<ServiceKeyV6, ServiceValue> + Send + 'static,
    E4: BpfMap<EndpointKey, EndpointValueV4> + Send + 'static,
    E6: BpfMap<EndpointKey, EndpointValueV6> + Send + 'static,
{
